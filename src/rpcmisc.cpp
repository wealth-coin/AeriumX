...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total aeriumx balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zAEXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zAEX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zAEX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zAEX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zAEX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zAEX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zAEX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zAEX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zAEX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zAEX denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in aeriumx/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in aeriumx/kb\n"
    ...
    UniValue zaexObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zaexObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zaexObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zAEXsupply", zaexObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given aeriumx address.\n"
            "\nArguments:\n"
            "1. \"aeriumxaddress\"     (string, required) The aeriumx address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"aeriumxaddress\", (string) The aeriumx address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: AeriumX address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are aeriumx addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) aeriumx address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"aeriumxaddress\"  (string, required) The aeriumx address to use for the signature.\n"
