...
WealthSilo now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<aeriumx_address\> \<monthly_payment_aeriumx\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ WealthSilo, _12_ times over the course of a year totaling _24000_ WealthSilo.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<aeriumx_address\> \<monthly_payment_aeriumx\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` WealthSilo.
