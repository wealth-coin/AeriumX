 ...
 */
    ...
    typeWidget->addItem(tr("Received WEALTH from zWEALTH"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zWEALTH"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zWEALTH));
...
void TransactionView::setModel(WalletModel* model)
{
    ...
    if (model) {
        ...
        transactionView->setStyleSheet("border:0px; background-color:rgba(255, 255, 255, 0.4); padding-right:2px; font-family:tahoma, verdana, arial, sans-serif;");
