...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("WealthSilo Core");
    ...
    QString copyrightTextWealthSilo = QChar(0xA9) + QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The WealthSilo Core developers"));
    ...
    pixPaint.setPen(QColor(239, 239, 239));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextWealthSilo);
...
static void InitMessage(SplashScreen* splash, const std::string& message)
{
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        Q_ARG(QColor, QColor(239, 239, 239)));
}
