...
/** Utility functions used by the WealthSilo Qt UI.
 */
namespace GUIUtil
{
...
// Render WealthSilo addresses in monospace font
...
// Parse "wealthsilo:" URI into recipient object, return true on successful parsing
