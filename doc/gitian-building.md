...
- [Building WealthSilo](#building-wealthsilo)
...
Clone the git repositories for wealthsilo and gitian and then checkout the wealthsilo version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/wealthsilo-crypto/wealthsilo.git
cd wealthsilo
...
Follow the instructions in [doc/release-process.md](release-process.md) in the wealthsilo repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the wealthsilo repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/wealthsilo/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/wealthsilo-crypto/wealthsilo
...
For example:
```bash
URL=https://github.com/crowning-/wealthsilo.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit wealthsilo=${COMMIT} --url wealthsilo=${URL} ../wealthsilo/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit wealthsilo=${COMMIT} --url wealthsilo=${URL} ../wealthsilo/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit wealthsilo=${COMMIT} --url wealthsilo=${URL} ../wealthsilo/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/wealthsilo-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/wealthsilo-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/wealthsilo-build.assert
```
...
[wealthsilo/gitian.sigs](https://github.com/wealthsilo-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
