...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AeriumX Core aeriumx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  aeriumx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aeriumx transaction") + "\n" +
                               "  aeriumx-tx [options] -create [commands]   " + _("Create hex-encoded aeriumx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded aeriumx transaction
