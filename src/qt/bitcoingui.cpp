                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WealthSilo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WealthSilo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wealthsilo: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWEALTH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WealthSilo Core"), this);
    aboutAction->setStatusTip(tr("Show information about WealthSilo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WealthSilo"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WealthSilo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WealthSilo addresses"));
    ...
    openAction->setStatusTip(tr("Open a WealthSilo: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WealthSilo Core help message to get a list with possible WealthSilo command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WealthSilo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WealthSilo network", "", count));
}
...
{
    QString strTitle = tr("WealthSilo Core"); // default title
