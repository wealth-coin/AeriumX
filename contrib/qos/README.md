...
This means one can have an always-on aeriumxd instance running, and another local aeriumxd/wealthsilo-qt instance which connects to this node and receives blocks from it.
